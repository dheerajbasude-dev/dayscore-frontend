...
export default function RewardsView() {
  ...
  useEffect(() => {
    ...
    const loadRewardsData = async () => {
      ...
      if (!isMounted) return;
      setRewards(Array.isArray(loadedRewards) ? loadedRewards : [])
      setPunishments(Array.isArray(loadedPunishments) ? loadedPunishments : [])
      setMilestones(store.getStreakMilestoneRewards() || {})
      setClaimsHistory(store.getClaimsHistory() || [])
    }
